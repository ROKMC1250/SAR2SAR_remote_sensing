...
parser.add_argument('--test_dir', dest='test_dir', default='./result_testA', help='test examples are saved here')
parser.add_argument('--test_data', dest='test_data', default='./satellite300/testA', help='data set for testing')
parser.add_argument('--stride_size', dest='stride_size', type=int, default=8, help='define stride when image dim exceeds 264')
...
def denoiser_test(denoiser):
    ...
    test_files = glob((test_data+'/*.TIF').format('uint8'))
